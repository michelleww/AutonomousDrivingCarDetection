...
# train_dir
# = ".\\test\\image_left\\"
# for each_image in os.listdir(train_dir
#):
#     if each_image.endswith(".jpg"):
#         # save all images
#         print("Detecting image: " + str(each_image))
#         object_detection_api(train_dir
#+str(each_image))


# Detect train\image_left folder
train_dir = ".\\train\\image_left\\"
for each_image in os.listdir(train_dir):
    if each_image.endswith(".jpg"):
        # save all images
        print("Detecting image: " + str(each_image))
