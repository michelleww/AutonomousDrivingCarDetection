...
if __name__ == "__main__":
    ...
    #datasetDir = '../../KITTI_Road_Data'
    #outputDir_perspective = '../../KITTI_Road_Data/train_baseline_perspective'

    #datasetDir = '/hri/storage/user/rtds/KITTI_Road_Data'
    #outputDir_perspective = '/hri/storage/user/rtds/KITTI_Road_Data/train_baseline_perspective'
    ...
    outputDir_perspective = os.path.join(outputDir_perspective, 'baseline_perspective_train')
