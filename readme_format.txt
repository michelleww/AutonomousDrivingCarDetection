...
The images taken for project 2 are taken from the KITTI dataset
...
found in the folder gt_image_2. Ground truth is available as binary 
PNG images [0,255]. The ground truth file names have two prefixes, 
...
Python Dependencies:
====================
The python files in this development kit where created with python 2.6 
